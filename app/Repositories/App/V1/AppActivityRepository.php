...
class AppActivityRepository extends ActivityRepository implements IAppActivity
{
    ...
    public function appGetAllActivitiesByTeacherId(string $id, $params = null): object
    {
        try {
