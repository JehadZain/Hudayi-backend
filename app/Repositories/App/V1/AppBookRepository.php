...
class AppBookRepository extends BookRepository implements IAppBook
{
    ...
    public function appGetAllSchoolBooks($params = null): object
    {
    ...
    public function appGetAllMosqueBooks($params = null): object
    {
        try {
