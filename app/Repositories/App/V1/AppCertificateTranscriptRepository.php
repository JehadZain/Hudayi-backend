...
class AppCertificateTranscriptRepository extends CertificateTranscriptRepository implements IAppCertificateTranscript
{
    public function appAll($params): object
    {
        try {
