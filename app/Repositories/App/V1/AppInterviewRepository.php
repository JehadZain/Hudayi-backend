...
class AppInterviewRepository extends InterviewRepository implements IAppInterview
{
    ...
    public function appGetAllInterviewsByTeacherId(string $id, $params = null): object
    {
        try {
