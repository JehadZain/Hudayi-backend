...
class AppTeacherRepository extends TeacherRepository implements IAppTeacher
{
    ...
    public function appGetAllOrgTeacher($params = null): object
    {
        try {
    ...
    public function teacherStatistics(string $id): object
    {
        ...
        try {
            ...
            // Retrieve interviews where type is 'تربوي' within the previous month
    ...
    public function appGetTeacherClassRooms($params): object
    {
        try {
