...
class AppUserRepository extends UserRepository implements IAppUser
{
    ...
    public function appAllUsersNotApproved($params = null): object
    {
        try {
            $this->builder = $this->builder->select(
                'id',
    ...
    public function appTransferObject($object, $id): object
    {
        try {
            DB::beginTransaction();
